...
const dialects = {
  ...
  'mysql2':require(`./dialects/mysql2/index.js`),
  'oracledb':require(`./dialects/oracledb/index.js`),
  'postgres':require(`./dialects/postgres/index.js`),
  'redshift':require(`./dialects/redshift/index.js`),
  'sqlite3':require(`./dialects/sqlite3/index.js`)
};
